...
from modules.db import obtener_balance_financiero, obtener_tareas_pendientes
from modules.ai import procesar_intencion_natural, pensar_respuesta, pensar_respuesta_imagen
