...
def registrar_split(usuario_id, monto_total, splits, cuenta_nombre="Efectivo", descripcion="",
    ...
    try:
        ...
        parent_ref = user_ref.collection("transactions").document(f"{year}-{month}").collection("items").document()
        parent_ref.set({
            "type": "expense",
        ...
        for split in splits:
            ...
            child_ref = user_ref.collection("transactions").document(f"{year}-{month}").collection("items").document()
            child_ref.set({
                "type": "expense",
